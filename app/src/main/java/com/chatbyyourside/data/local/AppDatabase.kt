...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * v11 -> v12：小说阵容定位（主角 / 配角）。
         *
         * novel_story 新增 castRolesJson TEXT NOT NULL DEFAULT '{}'：
         * '{}' = 尚未设置，读取端按成员顺序推导主角，不写回库；老故事原样可用。
         * 非破坏式 ALTER，故事/章节/正文与 NPC 数据全部保留。
         */
        val MIGRATION_11_12 = object : Migration(11, 12) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE novel_story ADD COLUMN castRolesJson TEXT NOT NULL DEFAULT '{}'")
            }
        }
