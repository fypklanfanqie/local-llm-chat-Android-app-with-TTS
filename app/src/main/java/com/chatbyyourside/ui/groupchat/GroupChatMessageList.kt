...
import com.chatbyyourside.ui.chat.ChatAutoScrollPolicy
import com.chatbyyourside.ui.chat.ChatUiState
import com.chatbyyourside.ui.chat.MessageBubble
import com.chatbyyourside.ui.chat.TypingIndicator
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

/**
 * 群聊消息列表：复用单角色 [MessageBubble]，逐条按 [DisplayMessage.characterId] 定位成员头像/名字。
 * 与 [com.chatbyyourside.ui.chat.ChatMessageList] 的关键差异：头像来源是「该条消息的发言人」，
 * 而非全局单一角色。
 *
...
/** 距底部多少 dp 内视为「接近底部」并保持跟随（与单聊 [com.chatbyyourside.ui.chat.ChatMessageList] 一致）。 */
