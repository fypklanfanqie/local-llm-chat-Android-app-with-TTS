 ...
 *  - [com.chatbyyourside.provider.local.LocalChatProvider] 计算有效线程数（min(用户设定, 大核数, 温度上限)）
 *  - [ThermalMonitor] 取大核数做按比例降频
 *  - [com.chatbyyourside.perfmon.PerformanceCollector] 经 LocalChatProvider 读大核频率
 *
